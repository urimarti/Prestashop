...
class ProductCore extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'condition' =>                    array('type' => self::TYPE_STRING, 'shop' => true, 'validate' => 'isGenericName', 'values' => array('2015','2014','2016','2017','2018','2019','2020'), 'default' => '2019'),
    ...
    */
        ...
        $only_active = false, Context $context = null)
    {
        ...
        if ($order_by == 'id_product' || $order_by == 'price' || $order_by == 'date_add' || $order_by == 'date_upd' || $order_by == 'on_sale') {
            $order_by_prefix = 'p';
